  ...
  <div class="pos_page">
    <div class="container-fluid p-0 app-admin-wrap layout-sidebar-large clearfix" id="pos">
      ...
      <b-row v-if="!isLoading">
        ...
        <b-col md="5">
          <b-card no-body class="card-order">
            <div class="main-header">
              ...
              <a @click="SetLocal('ps')">
                <i title="ps" class="flag-icon flag-icon-squared flag-icon-af"></i> پښتو
              </a>

              <a @click="SetLocal('fa')">
                <i title="fa" class="flag-icon flag-icon-squared flag-icon-af"></i> دری
              </a>
        ...
        <b-modal hide-footer size="md" scrollable id="modal_today_sales" :title="'Today\'s Sales'+ ' ( '+ today_sales.today +' )'">
